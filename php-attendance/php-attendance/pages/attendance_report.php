                    ...
                    <div class="container-fluid">
                        <fieldset>
                            ...
                            <div class="ps-4">
                                ...
                                <div><span class="text-warning fw-bold">E</span> <span class="ms-1">= Excuse</span></div>
                            </div>
                        </fieldset>
                    </div>
                </div>
                            ...
                            <table id="attendance-rpt-tbl" class="table table-bordered">
                                <thead>
                                    <tr class="bg-primary bg-opacity-75">
                                        ...
                                        <th class="text-center bg-primary text-light">TE</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <?php foreach($studentList as $row): ?>
                                        <tr class="student-row">
                                            ...
                                            <th class="text-center bg-secondary text-light"><?= $te ?></th>
                                        </tr>
                                    <?php endforeach; ?>
                                    <?php else: ?>
                                        <tr>
